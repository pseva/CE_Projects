create multiset table rtl_amr.T_TourismSumm_MetroSumm1 as
...
group by        1,2,3,4,5,6,7) with data primary index (purchase_date, store_metro, destination, product, in_metro, out_country, nomad, units, sales, transactions);